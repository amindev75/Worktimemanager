...
Enum.each(users, fn user_attrs ->
  # Vérifie si l'utilisateur existe déjà par son nom d'utilisateur
  case Repo.get_by(TimeManager.Accounts.User, username: user_attrs.username) do
    nil ->
    ...
    _user ->
      IO.puts("User #{user_attrs.username} already exists, skipping.")
  end
end)
