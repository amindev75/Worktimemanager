...
config :time_manager_api, TimeManagerWeb.Endpoint,
  ...
  secret_key_base: "yljmVaKOp42PSdMa+FtnrFDcOWIEFpaAJHpc7T7Z80NIqKM86maZ3Z6oDIMga3Fm",
  server: false

# In test we don't send emails
config :time_manager_api, TimeManager.Mailer, adapter: Swoosh.Adapters.Test
