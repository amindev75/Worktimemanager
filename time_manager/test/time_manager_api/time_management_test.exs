defmodule TimeManager.TimeManagementTest do
  ...
  describe "clocks" do
    ...
    import TimeManager.TimeManagementFixtures
    ...
    test "create_clock/1 with valid data creates a clock" do
      valid_attrs = %{status: true, time: ~N[2024-10-07 09:30:00]}

      assert {:ok, %Clock{} = clock} = TimeManagement.create_clock(valid_attrs)
      assert clock.status == true
      assert clock.time == ~N[2024-10-07 09:30:00]
    end
    ...
    test "update_clock/2 with valid data updates the clock" do
      clock = clock_fixture()
      update_attrs = %{status: false, time: ~N[2024-10-08 09:30:00]}

      assert {:ok, %Clock{} = clock} = TimeManagement.update_clock(clock, update_attrs)
      assert clock.status == false
      assert clock.time == ~N[2024-10-08 09:30:00]
    end
  ...
  describe "workingtimes" do
    ...
    test "create_workingtime/1 with valid data creates a workingtime" do
      valid_attrs = %{start: ~N[2024-10-07 09:30:00], end: ~N[2024-10-07 09:30:00]}

      assert {:ok, %Workingtime{} = workingtime} = TimeManagement.create_workingtime(valid_attrs)
      assert workingtime.start == ~N[2024-10-07 09:30:00]
      assert workingtime.end == ~N[2024-10-07 09:30:00]
    end
    ...
    test "update_workingtime/2 with valid data updates the workingtime" do
      workingtime = workingtime_fixture()
      update_attrs = %{start: ~N[2024-10-08 09:30:00], end: ~N[2024-10-08 09:30:00]}

      assert {:ok, %Workingtime{} = workingtime} = TimeManagement.update_workingtime(workingtime, update_attrs)
      assert workingtime.start == ~N[2024-10-08 09:30:00]
      assert workingtime.end == ~N[2024-10-08 09:30:00]
    end
  ...
  describe "workingtimes" do
    ...
    test "create_workingtime/1 with valid data creates a workingtime" do
      valid_attrs = %{start: ~N[2024-10-07 09:34:00], end: ~N[2024-10-07 09:34:00]}

      assert {:ok, %Workingtime{} = workingtime} = TimeManagement.create_workingtime(valid_attrs)
      assert workingtime.start == ~N[2024-10-07 09:34:00]
      assert workingtime.end == ~N[2024-10-07 09:34:00]
    end
    ...
    test "update_workingtime/2 with valid data updates the workingtime" do
      workingtime = workingtime_fixture()
      update_attrs = %{start: ~N[2024-10-08 09:34:00], end: ~N[2024-10-08 09:34:00]}

      assert {:ok, %Workingtime{} = workingtime} = TimeManagement.update_workingtime(workingtime, update_attrs)
      assert workingtime.start == ~N[2024-10-08 09:34:00]
      assert workingtime.end == ~N[2024-10-08 09:34:00]
    end
  ...
  describe "clocks" do
    ...
    test "create_clock/1 with valid data creates a clock" do
      valid_attrs = %{status: true, time: ~N[2024-10-07 09:34:00]}

      assert {:ok, %Clock{} = clock} = TimeManagement.create_clock(valid_attrs)
      assert clock.status == true
      assert clock.time == ~N[2024-10-07 09:34:00]
    end
    ...
    test "update_clock/2 with valid data updates the clock" do
      clock = clock_fixture()
      update_attrs = %{status: false, time: ~N[2024-10-08 09:34:00]}

      assert {:ok, %Clock{} = clock} = TimeManagement.update_clock(clock, update_attrs)
      assert clock.status == false
      assert clock.time == ~N[2024-10-08 09:34:00]
    end
